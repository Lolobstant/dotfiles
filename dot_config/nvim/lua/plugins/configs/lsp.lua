return function()
  ...
  vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(event)
      ...
      -- INFO: In this case, we create a function that lets us more easily define mappings specific
  ...
  -- INFO: LSP servers and clients are able to communicate to each other what features they support.
  ...
  -- INFO: Enable the following language servers
  ...
  -- INFO: Ensure the servers and tools above are installed
